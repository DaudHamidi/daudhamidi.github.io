...
**Required workflow:**
1. Upload assets to your preferred storage provider (for example S3, Cloudinary, or your own CDN).
2. Use the returned storage URL directly in your code: `<img src="https://cdn.example.com/image.png" />`
...
**CRITICAL:** Configure Google Maps access in your own environment and keep API keys in environment variables.
...
Never request API keys directly from end users.
...
```tsx
{
  "name": "hamidi-consulting-profile",
  "version": "1.0.0",
  "type": "module",
  "license": "MIT",
  "scripts": {
